            ...
            <div class='pl-sm-20 ml-sm-20'>
              ...
              <div class='d-flex flex-row flex-wrap'>
                ...
                <div class='mt-20 d-flex'>
                  ...
                  <button title="Share" class='btn bg-dark btn-lg btn-square d-flex align-items-center justify-content-center shadow-none border-0 ml-10' use:click={() => copyToClipboard(`https://miru.watch/anime/${media.id}`)}>
                    <Share2 size='1.7rem' />
                  </button>
